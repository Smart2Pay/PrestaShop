...
{/if}
<form name="s2p_payment_selector" id="s2p_payment_selector" method="post" action="{$s2p_module_obj->get_payment_link( ['link_for_form' => 1] )}">
        ...
        <div class="s2p_payment_module17">
            ...
            <span class="custom-radio pull-xs-left">
                <input class="ps-shown-by-js custom-radio"
                       id="s2p-payment-option-{$method_arr.method.method_id}"
                       name="method_id"
                       type="radio"
                       value="{$method_arr.method.method_id}"/><span></span>
            </span>
                <!--
                <a class="s2ppaymentmethod"
                   href="{$s2p_module_obj->get_payment_link( ['method_id' => {$method_arr.method.method_id}] )}"
                ...
                <div class="s2p_payment_method_image">
                    <img src="{$method_arr.method.logo_url}"
                         alt="{l s='Pay by' mod='smart2pay'} {$method_arr.method.display_name}"
