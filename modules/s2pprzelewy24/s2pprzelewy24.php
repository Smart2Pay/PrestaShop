 ...
 *
 */
class S2pprzelewy24 extends PaymentModule
{
    /** @var S2p $s2p */
    private $s2p;
    ...
    public function __construct()
    {
         ...
         * Method settings
         */
        $this->_methodName = 'przelewy24';
        $this->_methodID = 12;
        $this->_methodDisplayName = $this->l('Przelewy24');
        $this->_methodDescription = $this->l('Przelewy24 description');
