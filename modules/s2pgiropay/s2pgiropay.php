 ...
 *
 */
class S2pgiropay extends PaymentModule
{
    /** @var S2p $s2p */
    private $s2p;
    ...
    public function __construct()
    {
         ...
         * Method settings
         */
        $this->_methodName = 'giropay';
        $this->_methodID = 4;
        $this->_methodDisplayName = $this->l('Giropay');
        $this->_methodDescription = $this->l('Giropay description');
