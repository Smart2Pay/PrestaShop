...
<div class="row">
    <div class="col-xs-12">
        <p class="payment_module">
            <a class="s2ppaymentmethod" href="{$link->getModuleLink('smart2pay', 'payment', ['method_id' => {$method_arr.method.method_id}])}" title="{l s="Pay by {$method_arr.method.display_name} via Smart2Pay" mod="smart2pay"}">
                <img src="{$this_path}logos/{$method_arr.method.logo_url}" alt="{l s="Pay by {$method_arr.method.display_name} via Smart2Pay" mod="smart2pay"}" class="s2ppaymentlogo" />
                {l s="Pay by {$method_arr.method.display_name}" mod="smart2pay"}
