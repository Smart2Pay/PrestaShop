...
<div class="row">
    <div class="col-xs-12">
        <div class="s2p_payment_module17">
            ...
            <input class="ps-shown-by-js custom-radio" id="s2p-payment-option-{$method_arr.method.method_id}" name="method_id" type="radio" value="{$method_arr.method.method_id}" /><span></span>
            </span>
