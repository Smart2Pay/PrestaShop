 ...
 *
 */
class S2pmultibancosibs extends PaymentModule
{
    /**
     * Constructor
     */
    public function __construct()
    {
         ...
         * Method settings
         */
        $this->_methodName = 'multibancosibs';
        $this->_methodID = 20;
        $this->_methodDisplayName = $this->l('Multibanco SIBS');
        $this->_methodDescription = $this->l('Multibanco SIBS description');
